...
# ==================================================
# 3️⃣ HAFIZA YÖNETİCİSİ (V91: EXECUTIVE SUMMARY ENGINE)
# ==================================================
...
"""
    ...
    def _save_principle_v79(self, text, confidence, source_ids, domain, cluster_data):
        try:
            ...
            print("\n" + "=" * 60)
            print(f"📊 [ANALİZ LOGU] İÇTİHAT EVRİM RAPORU (V91)")
            print("-" * 60)
            ...
            payload = {
                ...
                "generated_by": "consolidation_v91",
                "timestamp": time.time(),
                "created_at": datetime.now().isoformat()
            }
    ...
    def consolidate_principles_v79(self):
        print("\n🔥 İÇTİHAT MİMARI: Artımlı Konsolidasyon (V91: Executive Summary)...")
        try:
            time_filter = Filter(
                must=[
                    FieldCondition(
...
"""
    ...
    def evaluate_candidates(self, candidates, story, topic, negatives):
        print("\n⚖️  Akıllı Yargıç Değerlendiriyor (V91: Executive Summary):")
        valid_docs = []
    ...
    def generate_final_opinion(self, story, topic, context_str):
        print("\n🧑‍⚖️  AVUKAT YAZIYOR (V91: Full Analysis)...")
...
class LegalReporter:
    @staticmethod
    def create_report(user_story, valid_docs, advice_text, filename="Hukuki_Rapor_V91.pdf"):
...
class LegalApp:
    def __init__(self):
        print("🚀 LEGAL SUITE V91 (Executive Summary Engine)...")
