...
3. **FORMAT:**
   ...
   A. MEVZUAT DAYANAKLARI
      ...
      - Örnek:
        * **TürkMedeniKanunu.pdf:** Madde 598'e göre...
        * **Miras Hukuku.pdf:** Miras paylaşımında...

   B. İLGİLİ EMSAL KARARLAR
      - Deliller arasındaki [EMSAL KARAR] etiketli belgeleri burada listele.
      - Örnek:
        * **buyuk7.pdf (Skor: %80):** Mahkeme şu kararı vermiştir... (Karar sonucunu kullan)
        * **buyuk6.pdf (Skor: %79):** Temyiz sonucunda...
