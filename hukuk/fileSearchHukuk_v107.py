...
# ==================================================
# 5️⃣ YENİ ARAÇLAR: REASONING & STRATEGY (V106-V107)
# ==================================================
...
class AppealArgumentGenerator:
    """V107: Hakim gerekçesine karşı otomatik itiraz üretici"""
...
class CorporateCover:
    @staticmethod
    def add(pdf, case_id, version="V107"):
        pdf.add_page()
...
# ==================================================
# 6️⃣ HAFIZA YÖNETİCİSİ (FULL EXPANDED)
# ==================================================
class LegalMemoryManager:
    ...
    def _calculate_principle_confidence(self, cluster):
        # Basit confidence hesabı (Full logic placeholder)
        count = len(cluster)
    ...
    def calculate_memory_consensus(self, source_name, current_decision, vector_score):
        try:
            ...
            ratio = match_c / len(p)
            return 1.15 if ratio > 0.8 else 0.85 if ratio < 0.2 else 1.0
        except:
            return 1.0
    ...
    def consolidate_principles_v79(self):
        print("\n🔥 İÇTİHAT MİMARI: Artımlı Konsolidasyon (V107)...")
        try:
    ...
    def _save_principle_v79(self, text, confidence, source_ids, domain, cluster_data):
        try:
            ...
            payload = {
                ...
                "generated_by": "consolidation_v107", "timestamp": time.time(), "created_at": datetime.now().isoformat()
            }
...
# ==================================================
# 8️⃣ YENİ ARAÇLAR: REASONING & STRATEGY (V105-V107)
# ==================================================
class WhiteLabelConfig:
    def __init__(self, firm_name="LEGAL OS", logo_path=None, footer_text="Otomatik Analiz Raporu", color=(0, 0, 0)):
        self.firm_name = firm_name
...
# ==================================================
# 9️⃣ RAPORLAMA SINIFI (BRANDED GENERATOR)
# ==================================================
...
class LegalReporter:
    ...
    def add_appeal_arguments_page(pdf, appeal_text):
        ...
        pdf.add_page()
        pdf.set_font("helvetica", "B", 12)
        pdf.cell(0, 10, "EK-3: OLASI ITIRAZ ARGUMANLARI (ISTINAF/TEMYIZ)", new_x=XPos.LMARGIN, new_y=YPos.NEXT)
        pdf.ln(5)
        pdf.set_font("helvetica", size=10)
    ...
    @staticmethod
    def create_report(user_story, valid_docs, advice_text, audit_data=None, filename="Hukuki_Rapor_V107.pdf", llm=None,
                      personas=None):
        ...
        CorporateCover.add(pdf, audit_data.get("case_id", "N/A") if audit_data else "N/A", "V107")
        ...
        if audit_data:
            ...
            # V107: Yan Yana Karşılaştırma
            if personas:
                # Clean persona text before passing
        ...
        try:
            pdf.output(filename); print(f"\n📄 Kurumsal Rapor (V107) Hazır: {filename}")
        except:
            pass


# ==================================================
# 1️⃣0️⃣ LEGAL UI PRINTER (28-POINT TRACKER)
# ==================================================
class LegalUIPrinter:
    ...
    def print_grand_ui_log(ui_data, doc_scan_log):
        ...
        print("\n" + "█" * 80)
        print(f"🖥️  LEGAL OS V107 - TAM KAPSAMLI ANALİZ VE TAKİP RAPORU (UI DATA)")
        print("█" * 80 + "\n")
...
class LegalApp:
    def __init__(self):
        print("🚀 LEGAL SUITE V107 (Defense Strategy Edition)...")
    ...
    def run(self):
        ...
        try:
            while True:
                ...
                current_personas = {}  # V107: Personaları saklamak için
                if self.memory_manager:
                    ...
                    # V107: En son analizden personaları al
                ...
                # V106/V107: Audit & LLM & Persona pass
                audit_dump = {}
                llm_instance = None
                ...
                self.reporter.create_report(story, valid_docs, full_advice, audit_dump, "Hukuki_Rapor_V107.pdf",
                                            llm_instance, current_personas)
