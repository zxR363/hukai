...
SOURCES = {
    "mevzuat": {
        "folder": "mevzuatlar",
        "collection": "legal_statutes_v48",  # Koleksiyonlar aynen korunuyor
        "desc": "MEVZUAT"
    },
    "emsal": {
        "folder": "belgeler",
        "collection": "legal_precedents_v48",  # Koleksiyonlar aynen korunuyor
        "desc": "EMSAL KARAR"
    }
}
...
# ==================================================
# 1️⃣ ARAÇLAR (KİLİT AÇICI & PDF OKUYUCU)
# ==================================================
def force_unlock_db():
...
def check_relevance_judge_smart(llm, user_query, user_filter, negative_keywords, document_text, source_name):
    ...
    # 2. YENİ PROMPT: DELİL DEĞİL, BENZERLİK ARIYORUZ (GÜNCELLENDİ)
    prompt_gen = f"""
...
"""
    ...
    # 3. YENİ KABUL KURALI: ZAYIF HARİÇ HEPSİ GEÇER (GÜNCELLENDİ)
...
# ==================================================
# 3️⃣ INDEXING ENGINE (DOKUNULMADI)
# ==================================================
def run_indexing_v54():
...
def create_pdf_report(user_story, valid_docs, advice_text, filename="Hukuki_Rapor_V54.pdf"):
    pdf = LegalReport();
    pdf.add_page();
...
# ==================================================
# 5️⃣ ANA MOTOR (V54: SIMILARITY JUDGE)
# ==================================================
def main():
    print("🚀 LEGAL SUITE V54 (Similarity Judge: Yargitay Ilkesi Odakli)...")

    if not run_indexing_v54(): sys.exit()
    ...
    while True:
        ...
        print("\n⚖️  Akıllı Yargıç Değerlendiriyor (Benzerlik Modu):")
        valid_docs = []
        ...
        # --- ANA RAPOR PROMPTU (DOKUNULMADI - V49 İLE AYNI) ---
        prompt = f"""
