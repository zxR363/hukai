...
# ==================================================
# 5️⃣ ANA MOTOR (V45: STRICT SEPARATION FIX)
# ==================================================
def main():
    print("🚀 LEGAL SUITE V45 (Strict Separation: No Hallucination)...")
    ...
    while True:
        ...
        for key, config in SOURCES.items():
            # Search limitini biraz arttıralım ki daha çok emsal şansı olsun
        ...
        for hit in candidates:
            ...
            if is_ok:
                extra_context = ""
                # V44 Özelliği: Dosya sonunu okuma
...
"""
        ...
        print("\n🧑‍⚖️  AVUKAT YAZIYOR (Strict Mode)...")

        # --- V45 PROMPT: ÇAPRAZ KULLANIM YASAĞI ---
        prompt = f"""
