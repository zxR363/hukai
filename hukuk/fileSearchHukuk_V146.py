...
class ActionableRecommendationEngine:
    ...
    def _generate_recommendation_text_with_score(self, concern, category_tr):
        ...
        Ayrıca bu aksiyonun davanın gidişatına etkisini (Impact Score) 1 ile 10 arasında değerlendir.
            ...
            if live_results:
                for res in live_results:
                    ...
                    payload = {
                        ...
                        "source": f"CANLI: {res.get('title', 'Bilinmeyen')}",
                        "type": "EMSAL",
                        "page": 1,
                        "url": res.get("url", "")
                    }
                    all_candidates.append(MockHit(payload, 0.85))
        except Exception as e:
            print(f"   ⚠️ Canlı arama hatası: {e}")
...
class LegalApp:
    def __init__(self):
        print(f"\n{'='*50}")
        print(f"⚖️  LEGAL AI SYSTEM - SURUM: V146 (Live Integration)")
        print(f"{'='*50}\n")
