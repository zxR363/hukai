    ...
    def run(self):
        ...
        try:
            while True:
                ...
                full_advice = self.judge.generate_final_opinion(ctx.query_text, ctx.topic, context_str)
                ...
                self.reporter.create_report(ctx.query_text, valid_docs, full_advice, audit_dump,
                                            "Hukuki_Rapor_V128.pdf",
                                            llm_instance, current_personas, full_query,
                                            precedent_cards=precedent_cards)  # V128: Kartları PDF'e gönder

                # 🔨 Commit 5.2 Entegrasyonu: Sade Tabloyu En Sonda Bas
