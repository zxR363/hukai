...
def create_pdf_report(user_story, valid_docs, advice_text, filename="Hukuki_Rapor_V47.pdf"):
    pdf = LegalReport();
    pdf.add_page();
...
# ==================================================
# 5️⃣ ANA MOTOR (V47: FULL DISCLOSURE + TRANSPARENT LOGS)
# ==================================================
def main():
    print("🚀 LEGAL SUITE V47 (Transparent Logistics: Console Reasons)...")
...
"""
        ...
        # --- V47 EKLENTİSİ: ŞEFFAF LOGLAMA ---
        print("\n" + "="*30)
        print("### Kaynaklar ve Sebebi")
        print("="*30)
        for d in valid_docs:
            print(f"• [{d['type']}] {d['source']} (Sf. {d['page']}) | Skor: %{d['score']*100:.1f}")
        ...
        # --- V45 PROMPT: ÇAPRAZ KULLANIM YASAĞI (Aynen Korundu) ---
        prompt = f"""
